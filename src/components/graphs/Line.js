...
const LineGraph = (props) => {
    ...
    const { historicalDate, baseCurrencey, exchangeCurrency, multiExchange } = props.info
    ...
    }, [historicalDate, baseCurrencey, exchangeCurrency, multiExchange])




    const data = {
        labels: makeDatesArray(historicalDate),
        datasets: [
            {
